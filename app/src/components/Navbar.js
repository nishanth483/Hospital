...
import { faPhone, faEnvelope, faHome, faTooth, faInfoCircle } from '@fortawesome/free-solid-svg-icons';
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto">
            ...
            <Nav.Link href="tel:7448584254" className="phone-link">
              <FontAwesomeIcon icon={faPhone} /> 744-858-4254
            </Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
